...
def calculate_brightness(background_color: dict) -> float:
    ...
    return sqrt(r_coefficient * background_color["R"] ** 2 + g_coefficient * background_color["G"] ** 2 + b_coefficient * background_color["B"] ** 2)
...
def avatar(first_name: str = "", last_name: str = "", initials: str = "", width: str = "md", button: bool = False) -> dict:
    """Generates an avatar based on the provided name"""
