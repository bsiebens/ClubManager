...
class MemberForm(forms.ModelForm):
    ...
    def save(self, commit: bool = True) -> Member:
        ...
        member = Member.create_member(first_name=self.cleaned_data["first_name"], last_name=self.cleaned_data["last_name"], email=self.cleaned_data["email"], password=password, member=self.instance)
