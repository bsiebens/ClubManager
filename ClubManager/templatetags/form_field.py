...
def form_field(field: BoundField, label: str | None = None, help_text: str | None = None, show_label: bool = True, show_help_text: bool = True,
               show_placeholder: bool = True, size: str = "full") -> dict:
    ...
    return {"field": field, "show_label": show_label, "show_help_text": show_help_text, "show_placeholder": show_placeholder, "field_type": field_type, "size_modifier": size_modifier}